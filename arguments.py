...
def add_hp_args(parser: argparse.ArgumentParser):
    ...
    group.add_argument("--w-align-loss", type=float, default=0.0)
    ...
    group.add_argument("--max-alignment-spans", type=int, default=512)
    group.add_argument("--max-schema-unit-tokens", type=int, default=96)
    ...
    group.add_argument("--w-token-relation-loss", type=float, default=0.5)
    ...
    group.add_argument("--use-attn-gate", action="store_true")
    group.add_argument("--no-attn-gate", action="store_false", dest="use_attn_gate")
    group.set_defaults(use_attn_gate=False)
...
def add_distillm_args(parser: argparse.ArgumentParser):
    ...
    # TSD-KD controls.
    group.add_argument("--tsd-beta", "--tsd_beta", dest="tsd_beta", type=float, default=0.9)
    group.add_argument("--tsd-lambda", "--tsd_lambda", dest="tsd_lmbda", type=float, default=1.0)
    group.add_argument(
        "--tsd-token-entropy-threshold",
        "--tsd_token_entropy_threshold",
        dest="tsd_token_entropy_threshold",
        type=float,
        default=0.1,
    )
    group.add_argument("--tsd-indirect-kd-alpha", "--tsd_indirect_kd_alpha", dest="tsd_indirect_kd_alpha", type=float, default=0.1)
    group.add_argument("--tsd-temperature", "--tsd_temperature", dest="tsd_temperature", type=float, default=1.0)
    group.add_argument("--tsd-top-k", "--tsd_top_k", dest="tsd_top_k", type=int, default=10)
    group.add_argument("--tsd-entropy-reg-weight", "--tsd_entropy_reg_weight", dest="tsd_entropy_reg_weight", type=float, default=1.0)

    group.add_argument("--use_dsa", action="store_true")
    group.add_argument("--use_hs", action="store_true")
    group.add_argument("--use-teacher-shared-attn", action="store_true")
    group.add_argument("--no-teacher-shared-attn", action="store_false", dest="use_teacher_shared_attn")
    group.add_argument("--use-span-length-weight", action="store_true")
    group.add_argument("--no-span-length-weight", action="store_false", dest="use_span_length_weight")
    group.add_argument("--debug-rel-scientific-log", action="store_true")
    ...
    group.add_argument("--ab-alpha", type=float, default=0.2)
    group.add_argument("--ab-beta", type=float, default=0.7)
    group.add_argument("--alphanet-alpha", type=float, default=0.5)
    group.add_argument("--alphanet-beta", type=float, default=0.9)
    group.set_defaults(use_teacher_shared_attn=True)
    group.set_defaults(use_span_length_weight=True)
