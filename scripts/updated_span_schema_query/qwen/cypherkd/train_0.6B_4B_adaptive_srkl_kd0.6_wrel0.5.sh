...
SAVE_TAG="updated_span_schema_query_${SCRIPT_GROUP}_${SCRIPT_NAME}"
...
EPOCHS=5
MAX_LENGTH=892
SAVE_PATH="${BASE_PATH}/results/updated_span_schema_query/qwen3/${SAVE_TAG}"
SEED=42
W_REL_LOSS=0.5
...
CMD="torchrun ${DISTRIBUTED_ARGS} ${BASE_PATH}/finetuning/updated_span_finetune_schema_query.py ${OPTS} $@"
