...
MAX_LENGTH=892
# runtime
SAVE_PATH="${SAVE_PATH:-${BASE_PATH}/results/qwen3/token_rel_loss_0.6B_4B_Cypherbench_csd_kd0.5}"
# seed
SEED=42
...
OPTS+=" --clip-grad 1.0"
OPTS+=" --epochs ${EPOCHS}"
OPTS+=" --kd-ratio ${KD_RATIO:-0.5}"
OPTS+=" --w-token-relation-loss ${W_TOKEN_RELATION_LOSS:-0.5}"
...
CMD="torchrun ${DISTRIBUTED_ARGS} ${BASE_PATH}/finetuning/finetune_token_rel_loss.py ${OPTS} $@"
