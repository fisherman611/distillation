...
# Model
CKPT_NAME="llama3.2-8B"
CKPT="${CKPT:-meta-llama/Meta-Llama-3-8B-Instruct}"
...
# Runtime
SAVE_PATH="${BASE_PATH}/results/finetune/llama3/sft_8B"
SEED=42
...
# OPTS+=" --peft-path results/llama3/sft_4B/e3-bs2-lr0.0001-G8-N2-NN1-lora-32-64-0.1/78"
# deepspeed
OPTS+=" --deepspeed"
