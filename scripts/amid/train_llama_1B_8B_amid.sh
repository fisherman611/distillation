...
# length
MAX_LENGTH=${MAX_LENGTH:-899}
MAX_PROMPT_LENGTH=${MAX_PROMPT_LENGTH:-810}
# seed
SEED=${SEED:-42}
...
SAVE_PATH="${SAVE_PATH:-${BASE_PATH}/results/llama3/amid/${AMID_DIV_NAME}_${AMID_DIV_ORDER}_${AMID_ALPHA}_${AMID_LAM}_bs${BATCH_SIZE}_lr${LR}}"
